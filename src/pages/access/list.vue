<template>
    <el-card shadow="never" class="border-0">
        ...
        <el-tree :expand-on-click-node="false" :data="tableData" :props="{ label:'name',children:'child' }" v-loading="loading" node-key="id" :default-expanded-keys="defaultExpandedKeys">
